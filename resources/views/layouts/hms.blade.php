            ...
            <div class="flex items-center gap-1.5">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.outside="open = false" x-cloak
                        ...
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-2.5 px-4 py-2 text-sm text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-white/5 transition-colors">
