...
<div class="flex h-screen overflow-hidden">
    ...
    >
        ...
        <nav class="flex-1 overflow-y-auto py-2 px-2 space-y-0.5">
            ...
            @canany(['view pharmacy', 'view purchases', 'view suppliers'])
            @module('pharmacy')
            ...
            <a href="{{ route('suppliers.index') }}" class="sidebar-link {{ request()->routeIs('suppliers.*') ? 'active' : '' }}">
                ...
                <span x-show="sidebarOpen" x-cloak>Suppliers</span>
            </a>
            @endcan
            @endmodule
...
(function () {
    ...
    function initTomSelect(el) {
        ...
        const settings = {
            ...
            maxOptions:       null,
            // Render the dropdown on <body> so it is never clipped by an
            // ancestor with overflow-hidden / overflow-x-auto (e.g. table cells
            // on the purchase form, cards, modals).
            dropdownParent:   'body',
            onInitialize() {
