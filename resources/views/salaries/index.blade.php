            ...
            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30">
                ...
                <td class="px-4 py-3">
                    <div class="flex items-center gap-1.5 justify-end">
                        <a href="{{ route('salaries.slip', $p) }}" target="_blank" title="Salary Slip"
                           class="p-1.5 rounded-lg text-slate-400 hover:bg-green-50 dark:hover:bg-green-900/20 hover:text-green-600 dark:hover:text-green-400 transition-colors">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                        </a>
                        @if($p->status === 'generated')
                        @can('manage salaries')
                        <button type="button" title="Pay" onclick="document.getElementById('pay-{{ $p->id }}').classList.toggle('hidden')"
                                class="p-1.5 rounded-lg text-slate-400 hover:bg-primary-50 dark:hover:bg-primary-900/20 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
