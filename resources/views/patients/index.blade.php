...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex gap-2">
        <a href="{{ route('patients.export', request()->query()) }}"
...
<form method="GET" class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-4 mb-4">
    <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <div class="flex gap-2">
            ...
            <a href="{{ route('patients.index') }}" class="btn-cancel">Reset</a>
        </div>
    </div>
</form>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/40 transition-colors">
                    ...
                    <td class="px-4 py-3">
                        <span class="text-xs px-2 py-0.5 rounded-full font-medium {{ $patient->status === 'active' ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-slate-100 text-slate-500 dark:text-slate-400' }}">
