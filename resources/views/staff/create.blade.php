...
<div class="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 p-6">
    ...
    <p class="text-xs text-slate-400 mb-4">Default password: <code class="bg-slate-100 dark:bg-slate-700 px-1.5 py-0.5 rounded">Staff@123</code></p>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="user_type" required class="w-full text-sm rounded-lg border-slate-300 dark:border-slate-600 dark:bg-slate-700 dark:text-white focus:border-primary-500">
...
<div class="flex gap-3">
    ...
    <a href="{{ route('staff.index') }}" class="px-4 py-2.5 bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-300 text-sm rounded-lg">Cancel</a>
</div>
