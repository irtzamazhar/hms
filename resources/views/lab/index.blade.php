                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center gap-1.5 justify-end">
                            <a href="{{ route('lab.show',$b) }}" title="View"
                            ...
                            <a href="{{ route('lab.report.pdf',$b) }}" target="_blank" title="Report PDF"
                            ...
                            @endif
                            @can('create lab bookings')
                            <button type="submit" form="deleteBooking{{ $b->id }}" title="Delete"
                                    onclick="return confirm('Delete booking {{ $b->booking_number }}? This cannot be undone.')"
                            ...
                            <form id="deleteBooking{{ $b->id }}" method="POST" action="{{ route('lab.destroy',$b) }}" class="hidden">
                                @csrf @method('DELETE')
                            </form>
                            @endcan
                        </div>
