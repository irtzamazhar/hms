        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                    ...
                    <td class="px-4 py-3"><x-badge color="{{ $d->is_active ? 'green' : 'slate' }}">{{ $d->is_active ? 'Active' : 'Inactive' }}</x-badge></td>
                    <td class="px-4 py-3">
                        <div class="flex gap-1">
                            <a href="{{ route('doctors.show',$d) }}" class="p-1.5 rounded text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-slate-700">
