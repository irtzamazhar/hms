...
<form method="POST" action="{{ route('shifts.update', $shift) }}"
    ...
    <div class="flex justify-between items-center pt-2">
        ...
        <div class="flex gap-3">
            <a href="{{ route('shifts.index') }}" class="px-4 py-2 border border-slate-300 dark:border-slate-600 text-slate-600 dark:text-slate-300 text-sm rounded-lg">Cancel</a>
