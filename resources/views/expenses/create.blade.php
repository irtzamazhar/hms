...
@section('breadcrumb')
    <a href="{{ route('expenses.index') }}" class="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200">Expenses</a>
...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('expenses.index') }}" class="text-sm text-slate-500 hover:text-slate-700 dark:hover:text-slate-200">← Back</a>
</div>
